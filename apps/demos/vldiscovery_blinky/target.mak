...
LDFLAGS += -Wl,-T$(BUILD)/misc/linker/f1/STM32F100XB_FLASH.ld,-Map,$(SELF_DIR)/$(TARGET).map
...
MIDDLEWARES = cmsis stm32f1_device_100xb stm32f1_hal stm32vl_discovery_bsp
